    ...
    <div className="pages">
      ...
      <div className="new-user-container">
        ...
        <form action="">
          ...
          <button onClick={formSubmission}>Create user</button>
        </form>
...
// H:\ \REWORK REACT PROJECT\amazon-react-clone-project-admin\amazon-clone-admin> npm start


export default Create_user_page